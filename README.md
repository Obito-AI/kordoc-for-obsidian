...
>
> v0.1.5 hardens Windows/macOS `npx` execution, includes `pdfjs-dist` for PDF parsing via npx mode, normalizes extracted image links, and defaults Markdown parse output to `10_SOURCE`.
